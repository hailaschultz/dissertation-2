...
COI_pa_wide_x<-COI_pa_wide_y[ , 24:325]
```
...
rotate
```{r}
NMDSmodel<-MDSrotate(NMDSmodel, COI_pa_wide_y$CTDTMP_DEG_C_ITS90_Surface...7)
```
get datascores
```{r}
...
data.scores$Station = COI_pa_wide_y$STATION_NO
data.scores$temp_deep = COI_pa_wide_y$CTDTMP_DEG_C_ITS90_Deep...6
data.scores$temp_surface = COI_pa_wide_y$CTDTMP_DEG_C_ITS90_Surface...7
data.scores$salinity_deep = COI_pa_wide_y$CTDSAL_PSS78_Deep...17
data.scores$salinity_surface = COI_pa_wide_y$CTDSAL_PSS78_Surface...18
data.scores$oxygen_deep = COI_pa_wide_y$OXYGEN_MG_L_1_Deep...10
data.scores$oxygen_surface = COI_pa_wide_y$OXYGEN_MG_L_1_Surface...20
data.scores$nitrate_deep = COI_pa_wide_y$NITRATE_UMOL_L_Deep...21
data.scores$nitrate_surface = COI_pa_wide_y$NITRATE_UMOL_L_Surface...22
```
