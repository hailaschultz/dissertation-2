...
#make unique column
Oxygen$code<-paste(Oxygen$Station, Oxygen$Year,Oxygen$Month,Oxygen$Depth,sep="-")
```
...
env_dend<-fviz_dend(res.hclust, rect = TRUE,repel=phylogenic,cex=0.5)
env_dend
